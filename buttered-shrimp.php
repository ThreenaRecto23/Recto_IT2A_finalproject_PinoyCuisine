...
<section class="menu">
	...
	<div class="row">
		<div class="menu-col-1" align="justify">
			...
			echo "<p> * 1 kilo shrimps</p><br>"; 
			echo "<p> * 3 tomatoes</p><br>"; 
			echo "<p> * 2 tablespoons butter</p><br>";
			echo "<p> * 3 cloves garlic </p><br>";
			echo "<p> * 1 small onion</p><br>";
			echo "<p> * Salt and pepper to taste </p><br>";
		...
		<div class="menu-col-1" align="justify">
			...
			echo "<p> <b>Step 1:</b> Heat the butter then saute the garlic, tomato and onion until soften then add the shrimp</p><br>"; 
			echo "<p> <b>Step 2:</b> Give a good stir to increase the heat, add the salt and pepper to taste then stir until done</p><br>"; 
			echo "<p> <b>Step 3:</b> Serve it hot</p><br>";
			?>
		</div>
...
<section class="photos">
	...
	<div class="pic">
		<img src="images/buttered-shrimp.png">
	</div>
</section>
